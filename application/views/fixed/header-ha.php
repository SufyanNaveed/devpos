        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                    ...
                    <?php if($this->aauth->get_user()->roleid == 5 || $this->aauth->get_user()->roleid == 6){ ?>
            ...
            if ($this->aauth->premission(2)) { ?>
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                    class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                        class="ft-list"></i> <?php echo $this->lang->line('Batch Manager') ?></a>
                            <ul class="dropdown-menu">
                                <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>services/add_batch"
                                                    data-toggle="dropdown"> <?php echo $this->lang->line('New Batch'); ?></a>
                                </li>
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>services/batch"
                                                    data-toggle="dropdown"><?= $this->lang->line('Manage Batch'); ?></a>
                                </li>
