...
class Employee_model extends CI_Model
{
    ...
    public function add_employee($id, $username, $name, $roleid, $phone, $address, $city, $region, $country, $postbox, $location, $salary = 0, $commission = 0, $department = 0,$whatsapp_link,$doc_image)
    {
        $data = array(
            'id' => $id,
            'username' => $username,
        ...
        if ($this->db->insert('geopos_employees', $data)) {
            ...
            $res = $this->db->update('geopos_users');
            // echo json_encode(array('status' => 'Success', 'message' =>
