...
class Pets extends CI_Controller{
    ...
    public function index()
    {
        ...
        // echo '<pre>'; print_r($data['pets']);exit;
    ...
    public function store()
    {
        ...
        // echo $pet_photo;exit;
        $res = $this->pets->addnew($pet_name, $pet_gender,$pet_color, $pet_breed, $pet_type, $microchip_number, $mark_difference,$date_of_birth,$pet_photo);
        if(res)
        {
            $this->session->set_flashdata('messagePr', 'Pet added Successfully!!');
            redirect('pets/index'); 
        }
        else{
